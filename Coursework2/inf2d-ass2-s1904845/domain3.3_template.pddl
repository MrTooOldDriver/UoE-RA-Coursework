(define (domain travelling)
    ...
    (:action MOVE
        ...
        :precondition (and (At ?t ?x) (Connect ?x ?y) (Mark ?y) (Moveable ?t))
        :effect (and (At ?t ?y) (not (At ?t ?x)))
    )

    (:action MOVE_WITH_YARN
        :parameters (?t -player ?x - location ?y - location ?i - item)
        :precondition (and (Autoadne ?t) (At ?t ?x) (Connect ?x ?y) (Holding ?t ?i) (Yarn ?i) (Object ?i) (> (yarn_remain ?i) 0) (not(Mark ?y)) (Moveable ?t))
        :effect (and (At ?t ?y) (not (At ?t ?x)) (decrease (yarn_remain ?i) 1) (Mark ?y))
    )

    (:action PICKUP
        :parameters (?t -player ?o - item ?x - location)
        :precondition (and (EmptyHand ?t) (Object ?o) (not(Yarn ?o)) (At ?t ?x) (At ?o ?x))
        :effect (and (Holding ?t ?o) (not (At ?o ?x)) (not(EmptyHand ?t)))
    )

    (:action PICKUP_YARN
        :parameters (?t -player ?o - item ?x - location)
        :precondition (and (EmptyHand ?t) (Object ?o) (Yarn ?o) (At ?t ?x) (At ?o ?x) (> (yarn_remain ?o) 0))
        :effect (and (Holding ?t ?o) (not (At ?o ?x)) (not(EmptyHand ?t)))
    )
    ...
    (:action DROP
        ...
        :precondition (and (At ?t ?x) (Holding ?t ?i) (Object ?i) (not(EmptyHand ?t)))
